...
@interface SNMessageTableViewController ()

@end

@implementation SNMessageTableViewController
...
- (void)viewDidLoad {
    ...
    SNSearchBar *searchBar = [SNSearchBar searchBar];
    
    searchBar.frame = CGRectMake(100, 100, 150, 30);
//    searchBar.width = 150;
//    searchBar.height = 30;
//    searchBar.x = 100;
//    searchBar.y = 100;
